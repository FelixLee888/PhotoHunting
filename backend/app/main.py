...
async def lifespan(_: FastAPI):
    ...
    dlna_manager = DLNAManager(settings)
...
def build_app() -> FastAPI:
    ...
    app.include_router(tv_router, prefix=settings.api_prefix)
    ...
    if static_frontend_dir and static_frontend_dir.exists():
        ...
        @app.get("/tv/", include_in_schema=False)
        def tv_root():
            tv_page = static_frontend_dir / "tv.html"
            return FileResponse(tv_page if tv_page.exists() else static_frontend_dir / "index.html")
